...
## Testing & Final Photos
### modeltest 
![Test on Note model](readmeimgs/modeltest.png)
![Custom Authentication Form test](readmeimgs/modeltest2.png)
### Sign in Sign up test resolutions.
![Landing page](readmeimgs/signupvw1440px.png)
![Landing Page 320px vw](readmeimgs/signupvw320.png)
![Landing Page 200px vw](readmeimgs/signupvw200px.png)
![Sign up successful anchor changes appearence](readmeimgs/signupsuccessful.png)
![Password Validation Error](readmeimgs/signupvalidationerrors.png)
![Password Validation Error](readmeimgs/signupvalidationerrorstwo.png)
![Sign In validation error](readmeimgs/loginerror.png)
### Add Note & Edit Note
![Add Note 1440px vw](readmeimgs/addnote1440pxvw.png)
![Add Note 320px vw](readmeimgs/addnote320pxvw.png)

![Error if trying to save note without title](readmeimgs/errorhandlingsaveemptynotetitle.png)

![Error if trying to save note without content](readmeimgs/errorhandlingsaveemptynotecontent.png)

![Confirmation popup if exit add note](readmeimgs/addnoteexitbtnconfirm.png)

![Confirmation popup if exit edit note](readmeimgs/editnoteexitbtnconfirm.png)

### Read View
![Read view after note updated](readmeimgs/readview.png)
